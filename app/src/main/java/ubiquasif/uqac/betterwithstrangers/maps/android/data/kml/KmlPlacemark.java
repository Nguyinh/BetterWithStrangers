...
import ubiquasif.uqac.betterwithstrangers.maps.android.data.Feature;
import ubiquasif.uqac.betterwithstrangers.maps.android.data.Geometry;

import java.util.HashMap;

/**
 * Represents a placemark which is either a {@link ubiquasif.uqac.betterwithstrangers.maps.android.data.kml.KmlPoint},
 * {@link
 * ubiquasif.uqac.betterwithstrangers.maps.android.data.kml.KmlLineString}, {@link ubiquasif.uqac.betterwithstrangers.maps.android.data.kml.KmlPolygon} or a
 * {@link ubiquasif.uqac.betterwithstrangers.maps.android.data.kml.KmlMultiGeometry}. Stores the properties and styles of the
 * place.
 */
